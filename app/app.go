...
=======
	app.Router().
>>>>>>> add basic structure for validator
	...
	lb.SetEndBlocker(lb.initEndBlocker)
...
func (lb *LinoBlockchain) initEndBlocker(ctx Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	if ctx.BlockHeight % validatorTenure != 0 {
		return nil
	}
