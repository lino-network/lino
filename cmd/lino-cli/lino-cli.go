...
var RootCmd = &cobra.Command{
	Use:   "lino",
	Short: "the LINO CLI tool wraps an Cosmos SDK",
	Long:  "the LINO CLI tool wraps an Cosmos SDK and uses for basic Linocoin operation",
	PersistentPreRunE: func(cmd *cobra.Command, args []string) error {

		switch cmd.Use {
		case "server": // for the examples apps, don't pre-run
			return nil
...
var serverCmd = &cobra.Command{
	Use:   "server",
	Short: "Lino cosmos server example",
	Long:  "Lino cosmos server example",
	Args:  cobra.ExactArgs(0),
	RunE: func(cmd *cobra.Command, args []string) error {
		return cmdServer(cmd, args)
	},
}
...
func cmdServer(cmd *cobra.Command, args []string) error {
