...
type RegisterMsg struct {
	...
	NewActivePubKey crypto.PubKey    `json:"new_active_public_key"`
}
...
func (msg RegisterMsg) String() string {
	return fmt.Sprintf("RegisterMsg{Newuser:%v, Master Key:%v, Post Key:%v, Active Key:%v}",
		msg.NewUser, msg.NewMasterPubKey, msg.NewPostPubKey, msg.NewActivePubKey)
}
