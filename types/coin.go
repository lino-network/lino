...
func LinoToCoin(lino LNO) (Coin, sdk.Error) {
	...
	return RatToCoin(new(big.Rat).Mul(num, big.NewRat(Decimals, 1)))
}
...
func RatToCoin(rat *big.Rat) (Coin, sdk.Error) {
...
func (coin Coin) ToRat() *big.Rat {
	return new(big.Rat).SetInt(coin.Amount.BigInt())
}
