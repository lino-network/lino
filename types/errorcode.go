...
const (
	...
	CodeProcessSourceDonation                sdk.CodeType = 424
	CodeProcessDonation                      sdk.CodeType = 425
	CodeUpdatePostIsDeleted                  sdk.CodeType = 426
	CodeReportOrUpvoteTooOften               sdk.CodeType = 427
	CodeReportOrUpvoteAlreadyExist           sdk.CodeType = 428
	CodeNoPostID                             sdk.CodeType = 429
	CodePostIDTooLong                        sdk.CodeType = 430
	CodeNoAuthor                             sdk.CodeType = 431
	CodeNoUsername                           sdk.CodeType = 432
	CodeCommentAndRepostConflict             sdk.CodeType = 433
	CodePostTitleExceedMaxLength             sdk.CodeType = 434
	CodePostContentExceedMaxLength           sdk.CodeType = 435
	CodeRedistributionSplitRateLengthTooLong sdk.CodeType = 436
	CodeIdentifierLengthTooLong              sdk.CodeType = 437
	CodeURLLengthTooLong                     sdk.CodeType = 438
	CodeTooManyURL                           sdk.CodeType = 439
	CodePostLikeNoUsername                   sdk.CodeType = 440
	CodePostLikeWeightOverflow               sdk.CodeType = 441
	CodePostLikeInvalidTarget                sdk.CodeType = 442
	CodeInvalidTarget                        sdk.CodeType = 443
	CodeCreatePostSourceInvalid              sdk.CodeType = 444
	CodeGetSourcePost                        sdk.CodeType = 445
