...
const (
	...
	CodeCheckMasterKey                     sdk.CodeType = 333
	...
	CodeGetMasterKey                       sdk.CodeType = 343
	CodeGetTransactionKey                  sdk.CodeType = 344
	CodeGetMicropaymentKey                 sdk.CodeType = 345
	CodeGrantTimesExceedsLimitation        sdk.CodeType = 346
	CodeUnsupportGrantLevel                sdk.CodeType = 347
	CodeRevokePermissionLevelMismatch      sdk.CodeType = 348
	CodeCheckUserTPSCapacity               sdk.CodeType = 349
	CodeAccountTPSCapacityNotEnough        sdk.CodeType = 350
	CodeAccountSavingCoinNotEnough         sdk.CodeType = 351
	CodeAccountAlreadyExists               sdk.CodeType = 352
	CodeRegisterFeeInsufficient            sdk.CodeType = 353
	...
	CodeUpdatePostIsDeleted                  sdk.CodeType = 425
	CodeReportOrUpvoteTooOften               sdk.CodeType = 426
	CodeReportOrUpvoteAlreadyExist           sdk.CodeType = 427
	CodeNoPostID                             sdk.CodeType = 428
	CodePostIDTooLong                        sdk.CodeType = 429
	CodeNoAuthor                             sdk.CodeType = 430
	CodeNoUsername                           sdk.CodeType = 431
	CodeCommentAndRepostConflict             sdk.CodeType = 432
	CodePostTitleExceedMaxLength             sdk.CodeType = 433
	CodePostContentExceedMaxLength           sdk.CodeType = 434
	CodeRedistributionSplitRateLengthTooLong sdk.CodeType = 435
	CodeIdentifierLengthTooLong              sdk.CodeType = 436
	CodeURLLengthTooLong                     sdk.CodeType = 437
	CodeTooManyURL                           sdk.CodeType = 438
	CodePostLikeNoUsername                   sdk.CodeType = 439
	CodePostLikeWeightOverflow               sdk.CodeType = 440
	CodePostLikeInvalidTarget                sdk.CodeType = 441
	CodeInvalidTarget                        sdk.CodeType = 442
	CodeCreatePostSourceInvalid              sdk.CodeType = 443
	CodeGetSourcePost                        sdk.CodeType = 444
