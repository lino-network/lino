...
import model "github.com/lino-network/lino/x/account/model"
...
func (_m *AccountKeeper) AddCoinToAddress(ctx types.Context, addr types.Address, coin linotypes.Coin) types.Error {
	ret := _m.Called(ctx, addr, coin)

	var r0 types.Error
	if rf, ok := ret.Get(0).(func(types.Context, types.Address, linotypes.Coin) types.Error); ok {
		r0 = rf(ctx, addr, coin)
	} else {
		if ret.Get(0) != nil {
...
func (_m *AccountKeeper) GetAddress(ctx types.Context, username linotypes.AccountKey) (types.Address, types.Error) {
	ret := _m.Called(ctx, username)

	var r0 types.Address
	if rf, ok := ret.Get(0).(func(types.Context, linotypes.AccountKey) types.Address); ok {
		r0 = rf(ctx, username)
	} else {
		if ret.Get(0) != nil {
...
// GetSavingFromAddress provides a mock function with given fields: ctx, address
func (_m *AccountKeeper) GetSavingFromAddress(ctx types.Context, address types.Address) (linotypes.Coin, types.Error) {
	ret := _m.Called(ctx, address)

	var r0 linotypes.Coin
	if rf, ok := ret.Get(0).(func(types.Context, types.Address) linotypes.Coin); ok {
		r0 = rf(ctx, address)
	} else {
...
// MinusCoinFromAddress provides a mock function with given fields: ctx, address, coin
func (_m *AccountKeeper) MinusCoinFromAddress(ctx types.Context, address types.Address, coin linotypes.Coin) types.Error {
	ret := _m.Called(ctx, address, coin)

	var r0 types.Error
	if rf, ok := ret.Get(0).(func(types.Context, types.Address, linotypes.Coin) types.Error); ok {
		r0 = rf(ctx, address, coin)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(types.Error)
		}
