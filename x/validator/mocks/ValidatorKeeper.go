...
func (_m *ValidatorKeeper) GetElectionVoteList(ctx types.Context, accKey linotypes.AccountKey) (*model.ElectionVoteList, types.Error) {
...
func (_m *ValidatorKeeper) GetValidatorList(ctx types.Context) (*model.ValidatorList, types.Error) {
	ret := _m.Called(ctx)
...
func (_m *ValidatorKeeper) InitGenesis(ctx types.Context) error {
	ret := _m.Called(ctx)
