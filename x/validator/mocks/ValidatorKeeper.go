...
// FireIncompetentValidator provides a mock function with given fields: ctx, byzantineValidators
func (_m *ValidatorKeeper) FireIncompetentValidator(ctx types.Context, byzantineValidators []abcitypes.Evidence) types.Error {
	ret := _m.Called(ctx, byzantineValidators)

	var r0 types.Error
	if rf, ok := ret.Get(0).(func(types.Context, []abcitypes.Evidence) types.Error); ok {
		r0 = rf(ctx, byzantineValidators)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(types.Error)
		}
...
// SetValidatorList provides a mock function with given fields: ctx, lst
func (_m *ValidatorKeeper) SetValidatorList(ctx types.Context, lst *model.ValidatorList) {
	_m.Called(ctx, lst)
}

// UpdateSigningStats provides a mock function with given fields: ctx, voteInfos
func (_m *ValidatorKeeper) UpdateSigningStats(ctx types.Context, voteInfos []abcitypes.VoteInfo) types.Error {
	ret := _m.Called(ctx, voteInfos)

	var r0 types.Error
	if rf, ok := ret.Get(0).(func(types.Context, []abcitypes.VoteInfo) types.Error); ok {
		r0 = rf(ctx, voteInfos)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(types.Error)
